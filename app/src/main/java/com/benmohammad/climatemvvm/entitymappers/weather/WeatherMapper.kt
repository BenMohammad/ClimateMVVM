package com.benmohammad.climatemvvm.entitymappers.weather
...
import com.benmohammad.climatemvvm.room.models.weather.*
...
class WeatherMapper(private val apiWeather: ApiWeather): Mapper<DbWeather> {
    ...
    override fun getMapping(): DbWeather {
        return DbWeather(
            WeatherData(
                Coord(
                    apiWeather.coord.lon, apiWeather.coord.lat),
                apiWeather.base,
                Main(
