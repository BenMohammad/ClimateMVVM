package com.benmohammad.climatemvvm.entitymappers.forecasts

import androidx.annotation.WorkerThread
import com.benmohammad.climatemvvm.entitymappers.Mapper
        ...
        return DbForecast(
            ForecastData(
                ...
                City(
                    ...
                    Coord(
                        apiForecast.city.coord.lat, apiForecast.city.coord.lon),
            ...
            apiForecast.list.asSequence().map {
                ForecastAndWeather(
                    Forecast(
                        ...
                        Wind(
                            it.wind.speed, it.wind.deg
                        ),
                        Sys(it.sys.pod),
                        it.dt_txt,
                        apiForecast.cod
                    ),
                    it.weather.asSequence().map {
